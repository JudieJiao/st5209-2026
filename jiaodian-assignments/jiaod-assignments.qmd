...
ggsave("../_images/a1-q4-c.png", width = 8, height = 5)
```
![](../_images/a1-q4-c.png)
...
ggsave("../_images/a1-q4-e.png", width = 8, height = 5)
```
...
canadian_gas |>
  ...
  labs(title = "Canadian Gas Production",
       ...
       x = "Month")
ggsave("../_images/a1-q5-1.png", width = 8, height = 5)
```
![](../_images/a1-q5-1.png)
```{r}
canadian_gas |>
...
gas |>
  ...
  labs(title = "Gas Production (Last 5 Years)",
       y = "Production",
       x = "Quarter")
ggsave("../_images/a1-q6-a.png", width = 8, height = 5)
```
![](../_images/a1-q6-a.png)
...
ggsave("../_images/a1-q6-b.png", width = 8, height = 5)
```
![](../_images/a1-q6-b.png)
...
gas |>
  ...
  labs(title = "Seasonally Adjusted Gas Production",
       ...
       x = "Quarter")
ggsave("../_images/a1-q6-d.png", width = 8, height = 5)
```
![](../_images/a1-q6-d.png)
...
ggsave("../_images/a1-q6-e-1.png", width = 8, height = 5)
```
![](../_images/a1-q6-e-1.png)
...
gas_outlier |>
  ...
  labs(title = "Seasonally Adjusted Gas Production (with Outlier)",
       y = "Seasonally Adjusted Production",
       x = "Quarter")
ggsave("../_images/a1-q6-e-2.png", width = 8, height = 5)
```
![](../_images/a1-q6-e-2.png)
...
ggsave("../_images/a1-q6-f-1.png", width = 8, height = 5)
```
![](../_images/a1-q6-f-1.png)
...
gas_outlier_end |>
  ...
  labs(title = "Seasonally Adjusted Gas Production (Outlier Near End)",
       y = "Seasonally Adjusted Production",
       x = "Quarter")
ggsave("../_images/a1-q6-f-2.png", width = 8, height = 5)
```
![](../_images/a1-q6-f-2.png)
...
ggsave("../_images/a1-q7-a.png", width = 8, height = 5)
```
![](../_images/a1-q7-a.png)
...
canadian_gas |>
  ...
  labs(title = "Seasonal Component Over Time",
       ...
       x = "Month")
ggsave("../_images/a1-q7-b.png", width = 8, height = 5)
```
![](../_images/a1-q7-b.png)
...
ggsave("../_images/a1-q7-c-1.png", width = 8, height = 5)
```
![](../_images/a1-q7-c-1.png)
...
canadian_gas |>
  ...
  labs(title = "Seasonal Component Over Time (Calendar Adjusted)",
       y = "Seasonal component",
       x = "Month")
ggsave("../_images/a1-q7-c-2.png", width = 8, height = 5)
```
![](../_images/a1-q7-c-2.png)
